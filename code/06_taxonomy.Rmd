...
prev_rDic <- subset_samples(phyloseq_s, SampleType == "REF-DIC") %>% prevalence() 
prev_rDim <- subset_samples(phyloseq_s, SampleType == "REF-DIM") %>% prevalence() 
prev_iDic <- subset_samples(phyloseq_s, SampleType == "IM-DIC") %>% prevalence() 
prev_iDim <- subset_samples(phyloseq_s, SampleType == "IM-DIM") %>% prevalence() 
```
