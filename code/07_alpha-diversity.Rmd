...
## Annotate the plot
```{r annotate_plot, fig.width = 9, fig.height = 11}
...
p_list <- lapply(
  ...
  function(x) 
  {
    ...
    plot_grid(p, lab, labels = "", ncol = 2, rel_widths = c(1.9,1))
  }
)
...
plot_grid(prow, legend, rel_widths = c(6, 1))

# Export figure
ggsave(here("result", "figures", "Figure 4.tiff"), width = 8, height = 10,
